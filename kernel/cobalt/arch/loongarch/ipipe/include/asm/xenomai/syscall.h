 ...
 * 02111-1307, USA.
 */
#ifndef _COBALT_LOONGARCH_ASM_SYSCALL_H
#define _COBALT_LOONGARCH_ASM_SYSCALL_H
 ...
 */
#define __xn_reg_sys(__regs)	(current_thread_info()->syscall)
...
#endif /* !_COBALT_LOONGARCH_ASM_SYSCALL_H */
